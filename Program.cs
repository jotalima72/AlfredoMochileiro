...
namespace ALfredoMochileiro
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Querido usuário, quantos indivíduos por geração você deseja?");
            int NumMochilas = Convert.ToInt32(Console.ReadLine());
            ...
            bool isTodosAlelosIguais = false;
            ...
            {
              Console.WriteLine("Mochila final:\n" + populacao[0] );
            }
        }
        ...
        public static (Mochila, Mochila) Cruzamento(Mochila m1, Mochila m2, List<Item> itensDisponiveis, int taxaMutacao)
        {
            ...
            // };
            Console.WriteLine("Aptidão do filho 1: " + filho1.Aptidations);
            ...
            //   };
            Console.WriteLine("Aptidão do filho 2: " + filho2.Aptidations);
